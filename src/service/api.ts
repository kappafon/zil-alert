...
export const DefaultApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createNewAlertContract(body: CreateNewAlertContractRequestDTO, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling createNewAlertContract.');
            }
            ...
            const needsSerialization = (<any>"CreateNewAlertContractRequestDTO" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
        ...
        loginUser(body: LoginUserRequestDTO, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"LoginUserRequestDTO" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(body || {}) : (body || "");
        ...
        registerNewUser(body: RegisterUserRequestDTO, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling registerNewUser.');
            }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"RegisterUserRequestDTO" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(body || {}) : (body || "");
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createNewAlertContract(body: CreateNewAlertContractRequestDTO, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<CreateNewAlertContractResponseDTO> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).createNewAlertContract(body, options);
         ...
         * @throws {RequiredError}
         */
        getUserContracts(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetUserContractsResponseDTO> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).getUserContracts(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        loginUser(body: LoginUserRequestDTO, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<LoginUserResponseDTO> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).loginUser(body, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        registerNewUser(body: RegisterUserRequestDTO, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).registerNewUser(body, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
...
export const DefaultApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        createNewAlertContract(body: CreateNewAlertContractRequestDTO, options?: any) {
            return DefaultApiFp(configuration).createNewAlertContract(body, options)(fetch, basePath);
        },
        /**
         * Returns alert contracts
         * @param {*} [options] Override http request option.
...
export class DefaultApi extends BaseAPI {
    ...
    public createNewAlertContract(body: CreateNewAlertContractRequestDTO, options?: any) {
        return DefaultApiFp(this.configuration).createNewAlertContract(body, options)(this.fetch, this.basePath);
    }
    ...
    public getUserContracts(options?: any) {
        return DefaultApiFp(this.configuration).getUserContracts(options)(this.fetch, this.basePath);
    }
    ...
    public registerNewUser(body: RegisterUserRequestDTO, options?: any) {
        return DefaultApiFp(this.configuration).registerNewUser(body, options)(this.fetch, this.basePath);
    }
